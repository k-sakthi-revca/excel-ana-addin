    ...
    const initializeTask = async () => {
      if (initialTask) {
        ...
        try {
          ...
          else if (initialTask === "Explain") {
            // Get sheet data
            const data = await excelDataUtils.getCurrentSheetData();
            setSheetData(data);
          }
          else if (initialTask === "Summarize") {
            // Get selection data
            const data = await excelDataUtils.getCurrentSelection();
    ...
    try {
      ...
      switch (task) {
        ...
        case "Explain":
          ...
          // Get explanation
          const explanation = await explainSheetApi.explainSheet(
